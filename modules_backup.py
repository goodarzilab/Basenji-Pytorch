...
class Trainer(nn.Module):
    ...
    '''
    def __init__(self, param_vals, model, memmap_data_contigs_dir, memmap_data_targets_dir_1, memmap_data_targets_dir_2 = None):
        ...
        self.make_optimizer()
        self.init_loss()
        self.make_dsets(memmap_data_contigs_dir, memmap_data_targets_dir_1, memmap_data_targets_dir_2, mode=mode)
        print ('init dsets')
...
#         num_targets = self.param_vals.get('num_targets', 1)
    ...
    def calc_pres_f1(self, y_true, y_pred): 
        ...
        pres = precision_score(y_true, y_pred, average='micro', zero_division=1)
        return pres, f1
